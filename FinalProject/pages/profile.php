...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="dashboard.php" target="_blank">
            <img src="../media/images/logo-ct.png" class="navbar-brand-img h-100" alt="logo">
            <span class="ms-1 font-weight-bold">Aisha Dashboard</span>
        </a>
    </div>
...
<div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
            ...
            <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
                ...
                <ul class="navbar-nav justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a href="sign-out.php" class="nav-link text-white font-weight-bold px-0">
                            <i class="fa fa-user me-sm-1"></i>
                            <span class="d-sm-inline d-none">Sign Out</span>
                        </a>
                    </li>
                    <li class="nav-item px-3 d-flex align-items-center">
                        <a href="sign-out.php" class="nav-link text-white p-0">
    ...
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4"
             style="background-image: url('../media/images/curved-images/curved0.jpg'); background-position-y: 50%;">
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../media/images/bruce-mars.jpg" alt="profile image"
                             class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1"> <?php if (!empty($userName)) {
                                print $userName;
                            } ?> </h5>
