...
if (!isset($_SESSION['user'])) {
    $_SESSION['ActivePage'] = "../pages/renters-dashboard.php";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link active " href="renters-dashboard.php">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Renters Dashboard</h6>
            </nav>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-2 pt-2 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 display" id="myTable3">
                                <thead>
                                <tr>
                                    <td hidden = "hidden" ></td>
                                ...
                                foreach ($tenantData as $data) {
                                    ...
                                    echo '<td class="border-bottom-0"><p class="text-xs  font-weight-bold mb-0 text-center">' . numfmt_format_currency($fmt,$data["RentAmount"],"CAD") . '</p ></td>';
                                    ...
                                    echo '</td >';
                                    deleteButton($data["id"],"renters-dashboard");

                                    // echo "<td class='border-bottom-0'><form action='renters-dashboard.php' method='post'><button name='delete' class='btn btn-danger text-xs mb-0'  value='".$data["id"]."' onclick=".'"return confirm('."'This will delete this message. Click Ok to Confirm !'".')" >Delete</button></form></td>';
