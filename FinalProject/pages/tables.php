...
if (!isset($_SESSION['user'])) {
    $_SESSION['ActivePage'] = "../pages/tables.php";
    ...
    $vistorTableData = getShortStay($pdo);
    $tenantData = getRenter($pdo);
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody><?php 
                                $i=0;
                                foreach ($vistorTableData as $data) {
                                    echo '<tr>';

                                    extracted($data);
                                    echo '<td class="border-bottom-0"><p class="text-xs font-weight-bold mb-0">' . $data["Date_Message"] . '</p ></td>';
                                    echo "<td class='border-bottom-0'><form action='tables.php' method='post'><button name='delete' class='btn btn-danger text-xs mb-0'  value='".$data["id"]."' onclick=".'"return confirm('."'This will delete this message. Click Ok to Confirm !'".')" >Delete</button></form></td>';
                                    ...
                                    // echo '<td>';
                                    // echo '</td >';
                                    // echo '<textarea rows="4" style="max-width: 100px;" class="text-xs font-weight-bold mb-0 text-center">' . $data["Comments"] . '</textarea>';
                                    $j=$data["Comments"]!=null ? "<span class='  badge rounded-pill bg-danger'>1<span class='visually-hidden'>message</span></span>": '';
                                    print <<<AE
                                                   <tr><td colspan='8'><div class="accordion" id="accordionExample$i">
                                        <div class="accordion-item">
                                        <h5 class="accordion-header" id="headingOne$i">
                                        <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne$i" aria-expanded="true" aria-controls="collapseOne$i">
                                            Message $j
                                                    </button>
                                                     </h5>
                                                    <div id="collapseOne$i" class="accordion-collapse collapse " aria-labelledby="headingOne$i" data-bs-parent="#accordionExample$i">
                                                    <div class="accordion-body row"><div class="form-floating"><textarea disabled class="col-md-12 form-control" style="height: 200px">
                                    AE;
                                    print strval($data["Comments"]);
                                    print <<<AS
                                            </textarea></div></div>
                                            </div>
                                            </div></div></div></td></tr>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                foreach ($investorData as $data) {
                                    echo "<tr>";
                                    extracted($data);
                                    echo '<td><p class="text-xs font-weight-bold mb-0 text-center">' . $data["Invest_Amount"] . '</p ></td>';
                                    ...
                                    $j=$data["Comments"]!=null ? "<span class='  badge rounded-pill bg-danger'>1<span class='visually-hidden'>message</span></span>": '';
                                    print <<<AE
                                                   <tr><td colspan='9'><div class="accordion" id="accordionExample$i">
                                        <div class="accordion-item">
                                        <h5 class="accordion-header" id="headingOne$i">
                                        <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne$i" aria-expanded="true" aria-controls="collapseOne$i">
                                            Message $j
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                foreach ($tenantData as $data) {
                                    ...
                                    echo '<td><p class="text-xs font-weight-bold mb-0 text-center">' . $data["RentAmount"] . '</p ></td>';
                                    echo '<td>';
                                    echo '<p class="text-xs font-weight-bold mb-0">' . $data["Date_Message"] . '</p >';
                                    echo '</td >';
                                    echo "<td class='border-bottom-0'><form action='tables.php' method='post'><button name='delete' class='btn btn-danger text-xs mb-0'  value='".$data["id"]."' onclick=".'"return confirm('."'This will delete this message. Click Ok to Confirm !'".')" >Delete</button></form></td>';
                                    ...
                                    $j=$data["Comments"]!=null ? "<span class='  badge rounded-pill bg-danger'>1<span class='visually-hidden'>message</span></span>": '';
                                    print <<<AE
                                                   <tr><td colspan='9'><div class="col-md-12"><div class="accordion" id="accordionExample$i">
                                        <div class="accordion-item">
                                        <h5 class="accordion-header" id="headingOne$i">
                                        <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne$i" aria-expanded="false" aria-controls="collapseOne$i">
                                            Message $j
                                                    </button>
                                                     </h5>
                                                    <div id="collapseOne$i" class="accordion-collapse collapse " aria-labelledby="headingOne$i" data-bs-parent="#accordionExample$i">
