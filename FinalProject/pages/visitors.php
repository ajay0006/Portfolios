...
if (!isset($_SESSION['user'])) {
    $_SESSION['ActivePage'] = "../pages/visitors.php";
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" /Aisha/index.php " target="_blank">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Short Stay Dashboard</h6>
                </nav>
                                ...
                                <table class="table align-items-center mb-0 display" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($vistorTableData as $data) {
                                            ...
                                            deleteButton($data["id"],"visitors");

                                            // echo "<td class='border-bottom-0'><form action='visitors.php' method='post'><button name='delete' class='btn btn-danger text-xs mb-0'  value='" . $data["id"] . "' onclick=" . '"return confirm(' . "'This will delete this message. Click Ok to Confirm !'" . ')" >Delete</button></form></td>';
